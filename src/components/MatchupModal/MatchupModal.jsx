...
export const MatchupModal = ({event, isOpen, setIsOpen}) => {

  const closeModal = () => {
    setIsOpen(false)
  }

  const getSpread = (odds) => {
        ...
        <Dialog as="div" className="z-10" onClose={closeModal}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-3xl transform overflow-hidden rounded-2xl p-6 text-left align-middle shadow-xl transition-all" style={{ backgroundImage: `linear-gradient(to right, #${event.competitors[1].color} , #${event.competitors[0].color})`}}>
                  <Dialog.Title
                    as="h3"
