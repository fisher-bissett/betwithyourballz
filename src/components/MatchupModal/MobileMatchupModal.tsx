...
export const MobileMatchupModal: React.FC<Props> = ({
  event,
  isOpen,
  setIsOpen,
  userId,
        ...
        <Dialog as="div" className="z-10" onClose={closeModal}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel
                  className="w-full h-full transform overflow-hidden rounded-2xl p-6 text-left align-middle shadow-xl transition-all"
                  style={{
